...
- marking_request — маркировка/ТНВЭД/ЭДО. ВАЖНО: если ПРИЧИНА именно маркировка («Отсутствует/Повреждена контрольная марка», «Честный Знак/ЧЗ не в обороте/не сходится дата», «нет кода/ДатаМатрикс», «расхождение по дате» в контексте ЧЗ) → event_type=marking_request ДАЖЕ при слове «возврат». НО: просто ФОТО детали/упаковки или слово «маркировка» о наклейке на товаре (без ЧЗ/контрольной марки/ДатаМатрикс/ТНВЭД) — это НЕ marking_request, а обычный возврат/брак.
