...
FOLDER_REVIEW = "Требуют проверки / Возвраты"
FOLDER_AI = "AI Assist"
FOLDER_READY = "Готово к 1С"
FOLDER_ERRORS = "Ошибки обработки"
FOLDER_PRE_DELIVERY = "Отказы до поставки"
FOLDER_SHORTAGE_LINK = "Недопоставка по ссылкам"
FOLDER_NUMBER_REPLACEMENT = "Замена номера / бренда"
FOLDER_MARKING = "Маркировка / ТНВЭД"
FOLDER_CORRECTION = "Корректировки / ЭДО / КСФ"
FOLDER_READY_TO_SHIP = "Готово к выдаче / забрать возврат"
...
FOLDER_UNKNOWN = "Неизвестные / ручная классификация"
